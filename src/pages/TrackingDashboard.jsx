  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <div className="bg-white shadow-sm z-10 lg:hidden">
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredRecords.map((record) => (
                      <TableRow
                        key={record._id}
                        className={isOverdue(record) ? "bg-red-50" : ""}
                      >
                        <TableCell>
                          <div>
              ...
              {selectedRecord && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label className="text-gray-500">Record</Label>
                    ...
                    <div>
                      <Label className="text-gray-500">Follow-up Date</Label>
